...
if(1){
	...
	//{
	setresultdiy(resultchoice, "bright pixels<=6", nResults-1, brightpixel);
...
if(1){		
	...
	for (i = 0; i < vercolgridno/2; i++) //0-41
	{
		...
		{
			if(shadegradient[p]>shadegradient[p-1])
			{
				shadescore++;
...
if(1){	 
	...
	if (diag1score>-9 && diag2score>-9 && horscore>-9 && verscore>-9 && wrinkle_image_mean<wrinkle_criteria && brightpixel<6 && darkspot <3 && hspeckleno<6 && deformity_image_mean<deformity_criteria && shademeanvalue<= shadecriteria )
